                  ...
                  <table class="table align-items-center table-flush">
					...
					<?php for($i=0; $i < count($salesData); $i++)
					{
						...
						<tr>
							...
							<!--
							<td><a <?php if($quantityData[$i] > 0){echo "href='salesreport.php?month=$currentMonth&day=$currentDay' class='btn btn-sm btn-primary'";}?>><?php if($quantityData[$i] > 0){echo 'Details';} else{echo '---';}?></a></td>
							-->
						</tr>
					<?php }
					}?>
