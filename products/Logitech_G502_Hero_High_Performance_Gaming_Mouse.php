                ...
                <div class="col-md-9 col-md-push-3">
                    <div class="row">
                                ...
                                <div class="swiper-container swiper-control-top">
                                   ...
                                   <div class="swiper-wrapper">
                                       <div class="swiper-slide">
                                            ...
                                            <div class="product-big-preview-entry swiper-lazy" data-background="../product_img/LogitechG502_gm.png"></div>
                                       </div>
									</div>
                                </div>
                                   ...
                                   <div class="swiper-wrapper">
                                       <div class="swiper-slide">
                                            <div class="product-small-preview-entry">
                                                <img src="../product_img/LogitechG502_gm~1.png" alt="" />
                                            </div>
                                        </div>
                                   </div>
                                </div>
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="h3 col-xs-b25"><span id="prod_name">Logitech G502 Hero High Performance Gaming Mouse</div>
                            <?php echo '<script type="text/javascript">document.title = "GG Mall | " + document.getElementById("prod_name").innerText;</script>';?>
                            <div class="row col-xs-b25">
                                <div class="col-sm-6">
                                    <div class="simple-article size-5 grey">PRICE: <span class="color">RM178.90</span></div>        
                                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="simple-article size-3 col-xs-b5">ITEM NO.: <span class="grey">07</span></div>
                                </div>
                                <div class="col-sm-6 col-sm-text-right">
							...
							• HERO 25K DPI<br>
							• 11 Buttons Fully Programmable<br>
							• Five 3.6g adjustable weights<br>
							• Weight – 121g (mouse only)<br>
							• USB report rate – 1ms
							</div>
