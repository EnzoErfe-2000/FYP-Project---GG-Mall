            ...
            <div class="row">
                <div class="col-md-9 col-md-push-3">
                    <div class="row">
                                ...
                                <div class="swiper-container swiper-control-top">
                                   ...
                                   <div class="swiper-wrapper">
                                       <div class="swiper-slide">
                                            ...
                                            <div class="product-big-preview-entry swiper-lazy" data-background="../product_img/SteelseriesAerox3_gm.png"></div>
                                       </div>
									</div>
                                </div>
                                   ...
                                   <div class="swiper-wrapper">
                                       <div class="swiper-slide">
                                            <div class="product-small-preview-entry">
                                                <img src="../product_img/SteelseriesAerox3_gm~1.png" alt="" />
                                            </div>
                                        </div>
                                   </div>
                                </div>
                        ...
                        <div class="col-sm-6">
                            <div class="simple-article size-3 grey col-xs-b5">Gaming Mice</div>
                            <div class="h3 col-xs-b25"><span id="prod_name">Steelseries Aerox 3 Wireless Lightweight Gaming Mouse</div>
                            <?php echo '<script type="text/javascript">document.title = "GG Mall | " + document.getElementById("prod_name").innerText;</script>';?>
                            <div class="row col-xs-b25">
                                <div class="col-sm-6">
                                    <div class="simple-article size-5 grey">PRICE: <span class="color">RM359.90</span></div>        
                                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="simple-article size-3 col-xs-b5">ITEM NO.: <span class="grey">09</span></div>
                                </div>
                                <div class="col-sm-6 col-sm-text-right">
							...
							• Ultra lightweight 57g design for effortlessly fast gameplay<br>
							• Super mesh USB-C detachable cable for less drag<br>
							• PTFE glide skates for silky smooth mouse movements<br>
							• Pixel-perfect TrueMove Core optical gaming sensor<br>
							</div>
