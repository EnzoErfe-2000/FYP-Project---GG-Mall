                ...
                <div class="col-md-9 col-md-push-3">
                    <div class="row">
                                ...
                                <div class="swiper-container swiper-control-top">
                                   ...
                                   <div class="swiper-wrapper">
                                       <div class="swiper-slide">
                                            ...
                                            <div class="product-big-preview-entry swiper-lazy" data-background="../product_img/RazerKrakenBluetoothKitty_GH.png"></div>
                                       </div>
									</div>
                                </div>
                                   ...
                                   <div class="swiper-wrapper">
                                       <div class="swiper-slide">
                                            <div class="product-small-preview-entry">
                                                <img src="../product_img/RazerKrakenBluetoothKitty_GH~1.png" alt="" />
                                            </div>
                                        </div>
                                   </div>
                                </div>
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="h3 col-xs-b25"><span id="prod_name">Razer Kraken Bluetooth Kitty Edition Wireless Gaming RGB Headset</div>
                            <?php echo '<script type="text/javascript">document.title = "GG Mall | " + document.getElementById("prod_name").innerText;</script>';?>
                            <div class="row col-xs-b25">
                                <div class="col-sm-6">
                                    <div class="simple-article size-5 grey">PRICE: <span class="color">RM410.90</span></div>        
                                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="simple-article size-3 col-xs-b5">ITEM NO.: <span class="grey">03</span></div>
                                </div>
                                <div class="col-sm-6 col-sm-text-right">
							...
							• Kitty ears and earcups powered by Razer Chroma RGB<br>
							• Bluetooth 5.0<br>
							• 40ms low latency connection<br>
							• Battery life – Up to 20 hours with Lighting on / Up to 50 hours with Lighting off<br>
							• Driver – 40mm<br>
							</div>
