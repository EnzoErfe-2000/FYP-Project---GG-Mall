            ...
            <div class="row">
                <div class="col-md-9 col-md-push-3">
                    <div class="row">
                                ...
                                <div class="swiper-container swiper-control-top">
                                   ...
                                   <div class="swiper-wrapper">
                                       <div class="swiper-slide">
                                            ...
                                            <div class="product-big-preview-entry swiper-lazy" data-background="../product_img/LogitechtMXMaster_om.png"></div>
                                       </div>
									</div>
                                </div>
                                   ...
                                   <div class="swiper-wrapper">
                                       <div class="swiper-slide">
                                            <div class="product-small-preview-entry">
                                                <img src="../product_img/LogitechtMXMaster_om~1.png" alt="" />
                                            </div>
                                        </div>
                                   </div>
                                </div>
                        ...
                        <div class="col-sm-6">
                            <div class="simple-article size-3 grey col-xs-b5">Office Mice</div>
                            <div class="h3 col-xs-b25"><span id="prod_name">Logitech MX Master 3 Wireless Mouse</div>
                            <?php echo '<script type="text/javascript">document.title = "GG Mall | " + document.getElementById("prod_name").innerText;</script>';?>
                            <div class="row col-xs-b25">
                                <div class="col-sm-6">
                                    <div class="simple-article size-5 grey">PRICE: <span class="color">RM424.90</span></div>        
                                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="simple-article size-3 col-xs-b5">ITEM NO.: <span class="grey">11</span></div>
                                </div>
                                <div class="col-sm-6 col-sm-text-right">
							...
							• 7 buttons<br>
							• Left/Right-click, Back/Forward, App-Switch, Wheel mode-shift, Middle click<br>
							• Wireless operating distance: 10 m<br>
