                ...
                <div class="col-md-9 col-md-push-3">
                    <div class="row">
                                ...
                                <div class="swiper-container swiper-control-top">
                                   ...
                                   <div class="swiper-wrapper">
                                       <div class="swiper-slide">
                                            ...
                                            <div class="product-big-preview-entry swiper-lazy" data-background="../product_img/MicrosoftBluetoothDesktopCombo_ok.png"></div>
                                       </div>
									</div>
                                </div>
                                   ...
                                   <div class="swiper-wrapper">
                                       <div class="swiper-slide">
                                            <div class="product-small-preview-entry">
                                                <img src="../product_img/MicrosoftBluetoothDesktopCombo_ok~1.png" alt="" />
                                            </div>
                                        </div>
                                   </div>
                                </div>
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="h3 col-xs-b25"><span id="prod_name">Microsoft Bluetooth Desktop Combo Keyboard</div>
                            <?php echo '<script type="text/javascript">document.title = "GG Mall | " + document.getElementById("prod_name").innerText;</script>';?>
                            <div class="row col-xs-b25">
                                <div class="col-sm-6">
                                    <div class="simple-article size-5 grey">PRICE: <span class="color">RM257.90</span></div>        
                                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="simple-article size-3 col-xs-b5">ITEM NO.: <span class="grey">14</span></div>
                                </div>
                                <div class="col-sm-6 col-sm-text-right">
							...
							• Slim, modern design at an exceptional value<br>
							• Save time and be more productive<br>
							• Connects wirelessly<br>
							</div>
