...
<div class="container-fluid" id="container-wrapper">
      ...
      <form method="post" action="insertproduct.php" enctype="multipart/form-data" >
					...
					<div class="form-group row">
                      ...
                      <div class="col-sm-9">
					   <input class="form-control " type="number"  step="0.01" min=0 name="product_regularPrice"placeholder="0.00">
                      </div>
                    </div>
					...
					<div class="form-group row">
                      ...
                      <div class="col-sm-9">
					   <input class="form-control " type="number"  step="0.01" min=0 name="product_listedPrice"placeholder="0.00">
                      </div>
                    </div>
					...
					<div class="form-group row">
                      ...
                      <div class="col-sm-9">
					   <input class="form-control " type="number" step="0.01"min=0  name="product_discountRate"placeholder="0.00">
                      </div>
                    </div>
					...
					<div class="form-group row">
                      ...
                      <div class="col-sm-9">
					   <input class="form-control " min=0 type="number" name="product_stock" placeholder="0">
                      </div>
                    </div>
