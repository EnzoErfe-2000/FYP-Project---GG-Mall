...
?>
                ...
                <div class="row">
                    <div class="col-sm-6 col-sm-offset-3">
                        <div class="cell-view simple-banner-height text-center">
                            ...
                            <div class="simple-article light transparent size-4">We are D720's 1st and Largest IT Hardware Store. We strive towards our longtime motto "fulfilling all your IT needs" and to serve you better.
</div>
                            <div class="empty-space col-xs-b35 col-sm-b70"></div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-sm-3">
                    <div class="icon-description-shortcode style-1">
                        ...
                        <div class="description simple-article size-2">JALAN AYER KEROH LAMA, 75450 BUKIT BERUANG, MELAKA</div>
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="icon-description-shortcode style-1">
                        ...
                        <div class="description simple-article size-2" style="line-height: 26px;">
                            <a href="tel:+35235551238745">+0121314520</a>
                        </div>
                    </div>
                </div>
                <div class="col-sm-3">
        ...
        <div class="container">
			<div class="gmap_canvas">
				<iframe width="1120" height="404" id="gmap_canvas" src="https://maps.google.com/maps?q=ALAN%20AYER%20KEROH%20LAMA,%2075450%20BUKIT%20BERUANG,%20MELAKA&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe>
				<a href="https://fmovies-online.net"></a>
				<br>
				<style>{position:center;text-align:center;height:404px;width:1200px;}</style>
				<a href="https://www.embedgooglemap.net">google maps websites</a>
				
				<style>.gmap_canvas {overflow:hidden;background:none!important;height:404px;width:1200px;}</style>
			</div>
		</div>
