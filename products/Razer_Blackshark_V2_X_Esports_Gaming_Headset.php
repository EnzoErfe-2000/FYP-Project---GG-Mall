                ...
                <div class="col-md-9 col-md-push-3">
                    <div class="row">
                                ...
                                <div class="swiper-container swiper-control-top">
                                   ...
                                   <div class="swiper-wrapper">
                                       <div class="swiper-slide">
                                            ...
                                            <div class="product-big-preview-entry swiper-lazy" data-background="../product_img/RazerBlacksharkV2X_GH.png"></div>
                                       </div>
									</div>
                                </div>
                                   ...
                                   <div class="swiper-wrapper">
                                       <div class="swiper-slide">
                                            <div class="product-small-preview-entry">
                                                <img src="../product_img/RazerBlacksharkV2X_GH~1.png" alt="" />
                                            </div>
                                        </div>
                                   </div>
                                </div>
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="h3 col-xs-b25"><span id="prod_name">Razer Blackshark V2 X Esports Gaming Headset</div>
                            <?php echo '<script type="text/javascript">document.title = "GG Mall | " + document.getElementById("prod_name").innerText;</script>';?>
                            <div class="row col-xs-b25">
                                <div class="col-sm-6">
                                    <div class="simple-article size-5 grey">PRICE: <span class="color">RM218.90</span></div>        
                                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="simple-article size-3 col-xs-b5">ITEM NO.: <span class="grey">02</span></div>
                                </div>
                                <div class="col-sm-6 col-sm-text-right">
							...
							• Razer™ TriForce 50mm Drivers<br>
							• Razer™ HyperClear Cardioid Microphone<br>
							• Advanced Passive Noise Cancellation<br>
							• 7.1 Surround Sound<br>
							• Frequency response: 12Hz – 28kHz<br>
							</div>
