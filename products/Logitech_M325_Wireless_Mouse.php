                ...
                <div class="col-md-9 col-md-push-3">
                    <div class="row">
                                ...
                                <div class="swiper-container swiper-control-top">
                                   ...
                                   <div class="swiper-wrapper">
                                       <div class="swiper-slide">
                                            ...
                                            <div class="product-big-preview-entry swiper-lazy" data-background="../product_img/LogitechM325_om.png"></div>
                                       </div>
									</div>
                                </div>
                                   ...
                                   <div class="swiper-wrapper">
                                       <div class="swiper-slide">
                                            <div class="product-small-preview-entry">
                                                <img src="../product_img/LogitechM325_om~1.png" alt="" />
                                            </div>
                                        </div>
                                   </div>
                                </div>
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="h3 col-xs-b25"><span id="prod_name">Logitech M325 Wireless Mouse</div>
                            <?php echo '<script type="text/javascript">document.title = "GG Mall | " + document.getElementById("prod_name").innerText;</script>';?>
                            <div class="row col-xs-b25">
                                <div class="col-sm-6">
                                    <div class="simple-article size-5 grey">PRICE: <span class="color">RM59.90</span></div>        
                                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="simple-article size-3 col-xs-b5">ITEM NO.: <span class="grey">12</span></div>
                                </div>
                                <div class="col-sm-6 col-sm-text-right">
							...
							• Smooth optical tracking<br>
							• DPI (Min/Max): 1000±<br>
							• Number of buttons: 5<br>
							• Connection Type: 2.4 GHz wireless connection<br>
							• Wireless range: 393.7 in (10m)<br>
							</div>
